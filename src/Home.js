   ...
   return (
     <div className="Home">
       ...
       <div style={{display: "inline-box", marginTop: "5vh", width: "100%"}}>
           ...
           <Button style={{ fontSize: "large"}}><Link style={{color: "#55769A", textDecoration: "none"}} to="/Movies">Movies</Link></Button>
           <Button style={{color: "#55769A", fontSize: "large", marginLeft: "3vw"}}><Link style={{color: "#55769A", textDecoration: "none"}} to="/Photos">Photos</Link></Button>
           <Button style={{color: "#55769A", fontSize: "large", marginLeft: "3vw"}}><Link style={{color: "#55769A", textDecoration: "none"}} to="/Writing">Writing</Link></Button>
           <Button style={{color: "#55769A", fontSize: "large", marginLeft: "3vw"}}><Link style={{color: "#55769A", textDecoration: "none"}} to="/Travel">Travel</Link></Button>
           {/* </div> */}
       </div>
     </div>
